...
# dataset part
parser.add_argument('--data_dir', type=str, default='dataset/wiki/4/')
...
for epoch in range(1, opt['num_epoch'] + 1):
    ...
    for i, batch in enumerate(train_batch):
        ...
        train_loss += loss
        # uf.append(user_hidden_out)
        # vf.append(item_hidden_out)
    ...
    user_hidden_out = trainer.h_u_final  #user_hidden_out
    item_hidden_out = trainer.h_v_final #item_hidden_out
